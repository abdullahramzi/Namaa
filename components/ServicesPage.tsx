...
import { Language, Currency, Service, CategoryId, ServiceCategory } from '../types';
...
const ServicesPage: React.FC<Props> = ({ lang, currency, searchQuery, services, onViewDetails, categories }) => {
  ...
  return (
    <div className="animate-fade-in min-h-screen">
      ...
      <div className="mb-10 text-center md:text-start">
         <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">{t.services[lang]}</h2>
         <p className="text-gray-500 dark:text-slate-400 max-w-2xl">{t.servicesDesc[lang]}</p>
      </div>
